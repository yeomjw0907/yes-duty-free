...
- [ ] **리뷰** – 상품별 리뷰 작성/조회 (DB 설계 있음, API·UI 연동)
- [ ] **쿠폰** – 주문 시 쿠폰 선택·적용, 할인 금액 반영 (coupons, user_coupons)
- [ ] **검색** – 상품명/브랜드 검색 완성 (헤더 검색창 연동)

---

## 🟡 해야 할 일 (중요)

- [ ] **배송 추적** – 주문 상세에 `tracking_number`, 택배사 링크 표시
- [ ] **관리자(Admin)** – 상품 등록/수정, 주문·회원 조회 강화
...
- [ ] 쿠폰 자동 발급, 1:1 문의
- [ ] 배너/이벤트 관리
- [ ] Toss Payments 등 실제 결제 PG 연동 (현재는 주문 생성만)
